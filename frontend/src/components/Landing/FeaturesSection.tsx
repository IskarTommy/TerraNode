...
const FEATURES: Feature[] = [
  {
    ...
    desc: "Prepare batches from authorized telemetry or canonical data, then anchor the integrity hash to a Sui traceability object.",
    tag: "Traceability",
  },
  {
    ...
    desc: "Each ProduceBatch stores crop, integer gram weight, custodian addresses, and a 32-byte integrity hash.",
    tag: "Layer 1",
  },
  {
    icon: "M7 17L17 7M17 7H7M17 7v10",
    title: "WMA Yield Estimate",
    desc: "A transparent weighted moving average uses sufficient genuine observations and reports when data is insufficient.",
    tag: "Analytics",
  },
  {
    ...
    title: "Genuine Data Inputs",
    desc: "Manual observations and dataset imports retain provenance, checksums, units, timestamps, and honest missing values.",
    tag: "Integrity",
  },
  {
    icon: "M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10zM9 12l2 2 4-4",
    title: "Encrypted Telemetry",
    desc: "AES-256-GCM protects telemetry at rest and canonical SHA-256 verification exposes tampering.",
    tag: "Privacy",
  },
  {
    icon: "M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71",
    title: "Custody Transfers",
    desc: "Only the current custodian can sign a handoff, and the backend rejects mismatched transactions or ownership.",
    tag: "Supply Chain",
  },
];
