...
The functional requirements describe the specific capabilities that TerraNode must provide. These were derived directly from the research objectives outlined in Chapter One. Table~\ref{tab:functional_req} presents the complete list of functional requirements mapped to their corresponding research objectives.
...
The non-functional requirements define the quality attributes and operational constraints that the system must satisfy. Table~\ref{tab:nonfunctional_req} presents the non-functional requirements that govern system performance, security, and usability.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/fig_er_diagram.png}
...
\begin{enumerate}[label=\roman*.]
    \item The client constructs a login message in the format: \\ ``\texttt{Login to TerraNode with \{sui\_public\_key\}}''.
